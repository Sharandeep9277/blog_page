...
const Input1 = ({ 
  ...
  return (
    <div className="w-full md:w-full lg:w-full inline-flex flex-col justify-start items-start gap-[8px] md:gap-[20px] ">
      ...
      <div className="self-stretch h-[48px] md:h-[55px] p-[16px] bg-white rounded-[8px] outline outline-1 outline-offset-[-1px] outline-black inline-flex justify-between items-center">
